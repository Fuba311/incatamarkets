    ...
    <head>
        ...
        <style>
            ...
            .floating-controls{
                ...
                overflow:hidden; z-index:1000; transition:width .2s ease;
            }
            .floating-controls.icon-only{ width:46px; }
            ...
            .controls-content{ padding:12px; max-height:70vh; overflow:auto; }
